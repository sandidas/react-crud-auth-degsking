...
const CourseSingle = () => {
    ...
    return (
        <div className="flex flex-col max-w-5xl mx-auto overflow-hidden rounded">
            ...
            <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-5xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-gray-900 dark:text-white bg-white text-dark shadow-md">
