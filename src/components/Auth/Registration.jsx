...
const Registration = () => {
    const { createNewUser, successMessage, setSuccessMessage, errorMessage, setErrorMessage, signinwithGoogle } = useContext(AuthContext);
    // register using Form
        ...
        <div>
            <div className="min-h-screen my-5 flex flex-col  items-center">
                ...
                <div className="min-w-[70%] flex flex-col p-6 rounded-md sm:p-10 dark:bg-gray-800 dark:text-gray-100 shadow-md shadow-slate-600">
                    ...
                    <div className='my-5'>
                        <button aria-label="Login with Google" onClick={handleGoogleSignin} className="flex items-center justify-center w-full p-4 my-2 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                                <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
                            </svg>
                            <p>Login with Google</p>
                        </button>
                        <button aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 my-2 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                    ...
                    <form onSubmit={(e) => handleRegister(e)}
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input type="text" name="name" id="name" placeholder="Full Name" className="w-full text-xl px-3 py-3 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100" />
                            </div>
                            <div>
                        ...
                        <div className="space-y-2">
                            ...
                            <button className="w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-400 dark:text-gray-900 hover:bg-purple-700 hover:text-white">Register</button>
