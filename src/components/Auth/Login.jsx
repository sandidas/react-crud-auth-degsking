...
const Login = () => {
    ...
    const { logInbyEmailAndPassword, successMessage, setSuccessMessage, errorMessage, setErrorMessage, signinwithGoogle } = useContext(AuthContext);
                ...
                <div className="min-w-[70%] flex flex-col p-6 rounded-md sm:p-10 dark:bg-gray-800 dark:text-gray-100 shadow-md shadow-slate-600">
                    ...
                    <form onSubmit={(e) => handleLogin(e)}
                        ...
                        <div className="space-y-2">
                            ...
                            <button className="w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-400 dark:text-gray-900 hover:bg-purple-700 hover:text-white">Login</button>
